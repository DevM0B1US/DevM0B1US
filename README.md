...
[![Followers](https://img.shields.io/github/followers/DevM0B1US?color=58a6ff&style=for-the-badge&label=FOLLOWERS&labelColor=0d1117&logo=github)](https://github.com/DevM0B1US?tab=followers)
...
### [KNHS School Management System](https://github.com/DevM0B1US/KNHS_WEBSITE)
...
```
Scale:          ████████████████████████████  25,000+ lines
Architecture:   ██████████████████████░░░░░░  Full-stack Nuxt 3
Commits:        ████████████████████████████  314+
...
- **Student Management** — Enrollment, academic records, performance tracking
- **Grade System** — Real-time grade management with complete audit logging
- **Academic Administration** — Academic year & curriculum management
- **Access Control** — Role-based permissions (Admin/Teacher/Student)
- **Emergency Systems** — Lockdown protocols with real-time notifications
...
|:--------|:------|:------:|:------------|
| **[KNHS Portal](https://github.com/DevM0B1US/KNHS_WEBSITE)** | Nuxt 3, TS, Supabase | 🟢 Live | 25K+ LOC school management system |
| **[HopKit](https://github.com/DevM0B1US/HopKit)** | Rust, Tauri v2 | 🟡 Dev | Cross-distro Linux package sync |
| **[M-drop](https://github.com/DevM0B1US/M-drop)** | Rust, Tauri v2 | 🟡 Dev | Local network file sharing |

### Active Development

| Project | Stack | Description |
|:--------|:------|:------------|
| **[M0B1US Blog](https://github.com/DevM0B1US/M0B1US_BLOG)** | Next.js 15, React 19, Prisma | Personal blog platform |
| **[Sugo Tacurong](https://github.com/DevM0B1US/Sugo_Tacurong)** | Nuxt.js | Regional tourism project |
| **[Arcza](https://github.com/DevM0B1US/Arcza)** | Nuxt.js, Neon PostgreSQL | Data-driven web application |
| **[Portfolio](https://github.com/DevM0B1US/Ceazar_portfolio)** | Nuxt.js | Personal portfolio site |
